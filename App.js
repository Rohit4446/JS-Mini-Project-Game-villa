 ...
 const getResults = (userChoice, computerChoice) => {
  switch (userChoice + computerChoice) {
    ...
    case 'rockpaper':
      ...
      if(totalScore.innerHTML >= 1){totalScore.innerHTML = parseInt(totalScore.innerHTML)-1;}
      break
...
window.addEventListener('click', (e) => {
   ...
   //  console.log("cc " + computerChoice);
    ...
    if(computerChoice == 'rock'){ computerChoice = rock;}else if(computerChoice == "paper"){computerChoice=paper}else if(computerChoice== 'scissors'){computerChoice=scissors};

  if(userchioce == 'rock' || userchioce == 'paper' || userchioce == 'scissors'){
